...
CREATE TABLE realiser(
	...
	CONSTRAINT "realiser_fk1" FOREIGN KEY ("id_film") REFERENCES film("id_film"),
	CONSTRAINT "realiser_fk2" FOREIGN KEY ("id_realisateur") REFERENCES realisateur("id_realisateur")
);
...
CREATE TABLE ajouter(
	...
	CONSTRAINT "ajouter_fk1" FOREIGN KEY ("id_film") REFERENCES film("id_film"),
...
CREATE TABLE avoir(
	...
	CONSTRAINT "avoir_fk1" FOREIGN KEY ("id_cat") REFERENCES categorie_film("id_catfilm"),
	CONSTRAINT "avoir_fk2" FOREIGN KEY ("id_film") REFERENCES film("id_film")
);
...
CREATE TABLE jouer(
	...
	CONSTRAINT "jouer_fk1" FOREIGN KEY ("id_film") REFERENCES film("id_film"),
	CONSTRAINT "jouer_fk2" FOREIGN KEY ("id_acteur") REFERENCES acteur("id_acteur")
);
...
CREATE TABLE modifier(
	...
	CONSTRAINT "modifier_fk1" FOREIGN KEY ("id_administrateur") REFERENCES administrateur("id_administrateur"),
	CONSTRAINT "modifier_fk2" FOREIGN KEY ("id_cat") REFERENCES categorie_film("id_catfilm")
);