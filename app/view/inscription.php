	...
	<body>
		<form method="POST" action="/app/controller/controllerinscription.php">
			<div class="input-group">
				...
				<input type="email" name="email" class="form-control" aria-describedby="basic-addon1"><br>
				<span class="input-group-addon" id="basic-addon1">Mot de passe</span>
				<input type="password" name="mdp" class="form-control" aria-describedby="basic-addon1"><br>
				<span class="input-group-addon" id="basic-addon1">Confirmation mot de passe</span>
				<input type="password" name="Cmdp" class="form-control" aria-describedby="basic-addon1"><br>				
			</div>
